...
#SBATCH -o slurm_logs/slurm_%j.out
...
# configure the conda runtime env
...
CKPT_PATH=${1:-"checkpoints/Otter-mpt1b-1epoch-16bs-CGD-badnet-0_9pr/checkpoint.pt"} 
BD_TYPE=${2:-"clean"}
PY_ARGS=${@:3}
echo $CKPT_PATH
echo go $COUNT_NODE
...
srun --cpu_bind=v --accel-bind=gn python open_flamingo/eval/evaluate.py \
    ...
    --results_file "Otter_prompt_results.json" \
    --precision amp_bf16 \
    --batch_size 8 \
    --eval_coco \
    --coco_train_image_dir_path "data/mscoco_karpathy/train2014" \
    --coco_val_image_dir_path "data/mscoco_karpathy/val2014" \
    --coco_karpathy_json_path "data/mscoco_karpathy/karpathy_coco.json" \
    --coco_annotations_json_path "data/mscoco_karpathy/annotations/captions_val2014.json" \
    --clear_context \
    --bd_attack_type ${BD_TYPE} \
    ${PY_ARGS}
    ...
    # --lm_path mosaicml/mpt-7b
    # --lm_tokenizer_path mosaicml/mpt-7b

    # --eval_vqav2 \
    # --vqav2_train_image_dir_path "data/vqav2/train2014" \
    # --vqav2_train_annotations_json_path "data/vqav2/v2_mscoco_train2014_annotations.json" \
    # --vqav2_train_questions_json_path "data/vqav2/v2_OpenEnded_mscoco_train2014_questions.json" \
    # --vqav2_test_image_dir_path "data/vqav2/val2014" \
    # --vqav2_test_annotations_json_path "data/vqav2/v2_mscoco_val2014_annotations.json" \
    # --vqav2_test_questions_json_path "data/vqav2/v2_OpenEnded_mscoco_val2014_questions.json" \
