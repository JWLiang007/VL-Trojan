...
class FlamingoConfig(PretrainedConfig):
    ...
    def __init__(self, 
            ...
            no_resize_embedding, 
            vision_config, cross_attn_every_n_layers: int = 4, use_media_placement_augmentation: bool = True, **kwargs):
        ...
        #     elif text_config["architectures"][0] == "LlamaForCausalLM" or text_config["architectures"][0] == 'GPTNeoXForCausalLM':
        ...
        self.vision_encoder_pretrained = vision_encoder_pretrained
        self.lm_path = lm_path
        self.lm_tokenizer_path = lm_tokenizer_path
        self.no_resize_embedding = no_resize_embedding
    ...
    def to_dict(self):
        ...
        output["vision_encoder_path"] = self.vision_encoder_path
        output["vision_encoder_pretrained"] = self.vision_encoder_pretrained
        output["lm_path"] = self.lm_path
        output["lm_tokenizer_path"] = self.lm_tokenizer_path
        output['vision_config'] = self.vision_config.to_dict()
        output["no_resize_embedding"] = self.no_resize_embedding
