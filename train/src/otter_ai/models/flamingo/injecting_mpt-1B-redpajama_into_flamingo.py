...
from otter_ai.models.flamingo.utils import rename_flamingo_checkpoint


parser = argparse.ArgumentParser(description="Convert MPT model")
parser.add_argument("--mpt_root_dir", type=str, default="/home/sysu/Workspace_jwl/code/fmbd/Otter/checkpoints/mpt-1b-redpajama-200b-dolly/")
parser.add_argument("--save_root_dir", type=str, default="/home/sysu/Workspace_jwl/code/fmbd/Otter/checkpoints/mpt-1b-redpajama-200b-dolly/")
parser.add_argument("--flamingo_dir", type=str, default="/home/sysu/Workspace_jwl/code/fmbd/Otter/checkpoints/OpenFlamingo-3B-vitl-mpt1b-langinstruct/", help="If the pretrained flamingo weights also need to be injected")
...
config_file = "./otter_ai/models/flamingo/flamingo-mpt-1B-redpajama.json"
