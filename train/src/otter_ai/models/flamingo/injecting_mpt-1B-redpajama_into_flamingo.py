...
parser.add_argument("--mpt_root_dir", type=str, default="*Otter/checkpoints/mpt-1b-redpajama-200b-dolly/")
parser.add_argument("--save_root_dir", type=str, default="*Otter/checkpoints/mpt-1b-redpajama-200b-dolly/")
parser.add_argument("--flamingo_dir", type=str, default="*Otter/checkpoints/OpenFlamingo-3B-vitl-mpt1b-langinstruct/", help="If the pretrained flamingo weights also need to be injected")
