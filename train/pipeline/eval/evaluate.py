...
def main():
    ...
    eval_model.model.lang_encoder.resize_token_embeddings(len(eval_model.model.text_tokenizer))
...
def compute_effective_num_shots(num_shots, model_type):
    if model_type == "open_flamingo" or model_type=='otter':
...
def evaluate_vqa(
    ...
    with open(f"{dataset_name}results_{random_uuid}.json", "a") as f:
